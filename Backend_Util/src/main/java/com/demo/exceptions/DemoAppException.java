 ...
 * application's business logic. It extends {@link RuntimeException}, making it
 * an unchecked exception. This means it does not need to be explicitly declared
...
public class DemoAppException extends RuntimeException {
	 ...
	 * cause.
	 * <p>
	 * Note that the cause is not automatically incorporated in the detail message
	 * of this exception.
	 *
	 * @param message the detail message (which is saved for later retrieval by the
	 *                {@link #getMessage()} method).
	...
	/**
	 * Constructs a new DemoAppException with the specified detail message, cause,
